...
auto TabGui::onRender(Renderer* r) -> void {
    ...
    for(auto category : categories) {
        ...
        if(selectedCat && selCatIndex == I) {
            ...
            r->fillRectangle(Vec4<float>(8.f, (I * height) + 9.f, selCatAnimModifier, ((I * height) + 9.f) + height), Color(3, 194, 252));
        };
        
        r->drawString(name, textSize, Vec2<float>(10.f, (I * height) + 10.f), Color(255, 255, 255));
