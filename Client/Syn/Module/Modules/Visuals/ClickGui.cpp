...
auto ClickGui::onRender(void) -> void {
    ...
    if(player != nullptr && entityMap.size() > 1 && ImGui::TreeNode(std::string("Entity Map").c_str())) {
        ...
        if(players.size() > 0 && ImGui::TreeNode(std::string("Players (" + std::to_string(players.size()) + ")").c_str())) {
        ...
        if((hostiles.size() > 0 || passives.size() > 0) && ImGui::TreeNode(std::string("Mobs (" + std::to_string(hostiles.size() + passives.size()) + ")").c_str())) {
        ...
        if(others.size() > 0 && ImGui::TreeNode(std::string("Others (" + std::to_string(others.size()) + ")").c_str())) {
